   ...
   const handleAddToCart = (e) => {
      ...
      if (addedItem) {
         ...
         addToCart({
            ...
            price: product.price,
            img: product.img,
            total: product.price.discount ? product.price.discount : product.price.original,
         });
      }
   };
   ...
   return (
      <button
         ...
         className={`w-full ${className} ${
            addedItem ? "bg-gray-900 hover:bg-gray-800 active:bg-gray-700 text-gray-100" : "bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-900"
