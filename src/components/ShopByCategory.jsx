   ...
   return (
      <div className="my-20">
         ...
         <div className="text-center">
            <p className="text-gray-500">Explore Our Collection – Find Exactly What You’re Looking For</p>
            <Link href={"/categories"} className="underline">View all categories</Link>
         </div>
      </div>
   );
};
